...
// EMPRENET
session_start();
$emprenetUsuario = $_SESSION['usuario'];
...
$dadosboleto["sacado"] = $emprenetUsuario['nome']." ".$emprenetUsuario['sobrenome'];
$dadosboleto["endereco1"] = $emprenetUsuario['endereco'];
$dadosboleto["endereco2"] = $emprenetUsuario['cidade']." - ".$emprenetUsuario['uf'];

// INFORMACOES PARA O CLIENTE
$dadosboleto["demonstrativo1"] = "Pagamento para uso do sistema Emprenet";
$dadosboleto["demonstrativo2"] = "Mensalidade referente a este ano<br>Taxa bancária - R$ ".number_format($taxa_boleto, 2, ',', '');
$dadosboleto["demonstrativo3"] = "BoletoPhp - http://www.boletophp.com.br";

// INSTRUÇÕES PARA O CAIXA
$dadosboleto["instrucoes1"] = "- Sr. Caixa, cobrar multa de 2% após o vencimento";
$dadosboleto["instrucoes2"] = "- Não receber após o vencimento";
$dadosboleto["instrucoes3"] = "- Em caso de dúvidas entre em contato conosco: emprenet.com";
...
// SEUS DADOS
$dadosboleto["identificacao"] = "Emprenet";
$dadosboleto["cpf_cnpj"] = "";
$dadosboleto["endereco"] = "Rua Brusque, 2926, Conjunto Santa Catarina, Potengi, CEP: 59112-490";
$dadosboleto["cidade_uf"] = "Natal / RN";
$dadosboleto["cedente"] = "Emprenet";
